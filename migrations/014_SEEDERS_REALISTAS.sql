-- ============================================
-- SEEDERS REALISTAS - 21 ENERO 2026
-- Usuarios bolivianos con datos reales
-- ============================================
...
INSERT INTO public.perfiles_profesionales (
  id, user_id, nombre_negocio, categoria, subcategorias, descripcion, ciudad,
  ...
  'Electricidad JC',
  'Hogar',
  ARRAY['Electricista', 'Instalaciones eléctricas'],
...
INSERT INTO public.perfiles_profesionales (
  ...
  'Plomería Rojas',
  'Hogar',
  ARRAY['Plomero', 'Instalaciones sanitarias'],
...
INSERT INTO public.perfiles_profesionales (
  ...
  'Muebles a Medida PG',
  'Hogar',
  ARRAY['Carpintero', 'Muebles a medida'],
...
INSERT INTO public.perfiles_profesionales (
  ...
  'TechSupport Bolivia',
  'Tecnología',
  ARRAY['Reparación de computadoras', 'Soporte técnico'],
...
-- VERIFICACIÓN
-- ============================================
SELECT 'SEEDERS REALISTAS - EJECUTADO CORRECTAMENTE' as resultado;
